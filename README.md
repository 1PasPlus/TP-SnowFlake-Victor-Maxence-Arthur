...
### 3.1	Top 10 des jobs les plus postés
...
### 3.2 Classement des jobs les mieux payés par intitulé de poste


### 3.3 Quelle est la répartition des offres d’emploi par taille d’entreprise ?
...
### 3.4 Quelle est la répartition des offres d’emploi par type d’industrie ?
...
### 3.5 Quelle est la réparation des offres d’emploi par type d’emploi (full-time, intership, part-time) ?
...
### 3.6 Suggestion d’analyse sur le nombre d’offres d’emploi par endroit 
